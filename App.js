...
const API_URL = "http://cchost.freeboxos.fr/LiveEvents/wp-json/wp/v2/posts?_embed&per_page=100";
  ...
  useEffect(() => {
    if (loading) {
      const interval = setInterval(() => {
        setLoadingText(prevLoadingText => prevLoadingText.endsWith('...') ? 'Loading' : prevLoadingText + '.')
      }, 500);
