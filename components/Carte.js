...
const toiletPins = [
    ...
    { latitude: 48.856700, longitude: 2.235015 },
    { latitude: 48.858987, longitude: 2.235873 },
];

const scenePins = [
    { latitude: 48.861624, longitude: 2.234115 },
    { latitude: 48.860198, longitude: 2.235520 },
...
const restauPins = [
    ...
    { latitude: 48.857229, longitude: 2.234960 },
    { latitude: 48.858739, longitude: 2.233940 },
    { latitude: 48.860018, longitude: 2.234124 },
    { latitude: 48.858020, longitude: 2.236077 },
];

const secourPins = [
    { latitude: 48.855680, longitude: 2.233895 },
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.legend}>
                <Text style={styles.textLegendScene}><Image source={sceneIcon} style={styles.sceneIconLegend} /> Scènes</Text>
                <Text style={styles.textLegend}><Image source={toiletIcon} style={styles.toiletIcon} /> Toilettes</Text>
                <Text style={styles.textLegend}><Image source={secourIcon} style={styles.secourIcon} /> Secours</Text>
                <Text style={styles.textLegend}><Image source={restauIcon} style={styles.restauIcon} /> Restaurations</Text>
            </View>
        </View>
    );
};
